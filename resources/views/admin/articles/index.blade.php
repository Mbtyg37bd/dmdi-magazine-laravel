                            ...
                            <td>
                                <div class="d-flex align-items-start">
                                    @if($article->featured_image)
                                        <div class="me-3" style="width:60px; height:40px; overflow:hidden; flex:0 0 60px;">
                                            @include('partials.featured-image', [
                                                'path' => $article->featured_image,
                                                'alt' => $article->title_id,
                                                'class' => 'img-fluid rounded',
                                                'sizes' => '(max-width: 576px) 100vw, 60px'
                                            ])
                                        </div>
                                    @else
                            ...
                            <td>
                                ...
                                @else
                                    <button class="btn btn-sm btn-outline-primary generate-qr" 
                                            ...
                                            data-generate-url="{{ route('articles.generate-qr', $article->id) }}"
                                            data-bs-toggle="tooltip"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.generate-qr').forEach(function(btn) {
        btn.addEventListener('click', function() {
            var button = this;
            var url = button.getAttribute('data-generate-url');
